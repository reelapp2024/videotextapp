...
export function buildMediaIndexSeries(mode, mediaCount, outputRows, seed) {
...
export function buildExportMediaPairing({
  outputRows = 0,
  videoMode = 'sequence',
  audioMode = 'sequence',
  imageMode = 'sequence',
...
export function resolvePairedIndex(pairing, key, rowIndex, fallbackCount) {
