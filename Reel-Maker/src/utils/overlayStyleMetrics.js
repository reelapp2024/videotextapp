...
/** Keep text block vertically inside canvas (matches export clamp). */
...
/** Keep horizontal anchor inside canvas for a line of given width. */
...
/** Max line width for wrap/fit — accounts for box padding and stroke (matches export). */
...
/** Shrink font when block is taller than safe area (keeps text inside canvas). */
